...
export function RicaForm() {
    ...
    const steps = [
        { id: 1, name: "Business Owner", fields: ['citizenship', 'identificationDocumentNumber', 'passportNumber', 'otherNames', 'surname', 'nationality', 'phone', 'email', 'ownerDistrict'] },
        { id: 2, name: "Business Details", fields: ['businessType', 'companyName', 'tin', 'registrationDate', 'businessDistrict'] },
        { id: 3, name: "Product Info", fields: ['importPurpose', 'productCategory', 'productName', 'weight', 'description', 'unit', 'quantity'] },
    ];
    ...
    return (
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 max-w-3xl  w-full mx-auto p-4">
                ...
                {currentStep == 1 && (<div className="space-y-4 p-6 border rounded-lg">
                ...
                {currentStep == 2 && (<div className="space-y-4 p-6 border rounded-lg">
                ...
                {currentStep == 3 && (<div className="space-y-4 p-6 border rounded-lg">
